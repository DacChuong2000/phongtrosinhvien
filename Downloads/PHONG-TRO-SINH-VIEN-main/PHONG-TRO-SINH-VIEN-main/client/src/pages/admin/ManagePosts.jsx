                            ...
                            {posts?.rows?.map(el => (
                                <tr className='border' key={el.id}>
                                    ...
                                    <td className='p-2 text-center '>
                                        <span className='flex justify-center items-center'>{el.star || 0} <AiFillStar color='orange' /></span>
                                    </td>
                                    ...
                                    <td className='p-2 text-center'>{el.area}<span>m<sup>2</sup></span></td>
                                    ...
                                    <td className='flex items-center justify-center gap-2 p-2'>
                                        <span
                                            onClick={() => dispatch(modal({ isShowModal: true, modalContent: <UpdatePost render={render} editPost={el} /> }))}
                                            className='text-lg text-main-red cursor-pointer px-1'
                                        >
                                            <AiOutlineEdit />
                                        </span>
                                        <span onClick={() => handleDeletePost(el.id)} className='text-lg text-main-red cursor-pointer px-1'><AiFillDelete /></span>
                                    </td>
                                </tr>
                            ))}
                        </tbody>
